...
![DevCalendar](https://img.shields.io/badge/React-18-61DAFB?style=flat-square&logo=react)
...
psql -U postgres -c "CREATE DATABASE devcalendar;"
...
### Gmail Integration
- **Import tasks**: Emails with `[DevCalendar]` in the subject line are automatically imported as tasks
  - Example subject: `[DevCalendar] Fix login bug`
